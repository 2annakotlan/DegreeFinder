...
def display_email_page():
    ...
    user_email = st.text_input(placeholder = "Student Email:", autocomplete = "off") # user input
    if user_email:
    ...
    if "verification_code" in st.session_state: # if verification code was sent... 
        user_code = st.text_input(placeholder = "Verification Code:", autocomplete = "off", help = f"code: {st.session_state.verification_code}") # user input  
...
def display_analytics_page():
    ...
    st.markdown("**Having trouble choosing a major?** Pick the classes you've taken and enjoyed, along with the ones you think you might enjoy, and discover which major best fits you!")
